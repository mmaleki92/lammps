...
#ifdef FIX_CLASS
// clang-format off
FixStyle(indentwca,FixIndentWCA);
// clang-format on
#else

#ifndef LMP_FIX_INDENTWCA_H
#define LMP_FIX_INDENTWCA_H

#include "fix.h"

namespace LAMMPS_NS {

class FixIndentWCA : public Fix {
 public:
  FixIndentWCA(class LAMMPS *, int, char **);
  ~FixIndentWCA() override;
